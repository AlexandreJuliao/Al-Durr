                            ...
                            <div className={`flex flex-col-reverse lg:flex-row gap-16 items-center ${idx % 2 !== 0 ? 'lg:flex-row-reverse' : ''}`}>
                                ...
                                <div className="flex-1 space-y-8">
                                    <div>
                                        ...
                                        <p className="text-aldurr-honey text-xs tracking-[0.3em] uppercase mb-4 font-bold">{model.subtitle}</p>
                                        
                                        {/* Patent Badge */}
                                        <div 
                                            onClick={() => setIsIpModalOpen(true)}
                                            className="group/ip-badge flex items-center gap-2 px-2.5 py-1.5 bg-white/[0.03] hover:bg-white/[0.08] border border-white/10 hover:border-aldurr-honey/30 rounded-none transition-all duration-300 cursor-pointer pointer-events-auto w-fit mb-6"
                                        >
