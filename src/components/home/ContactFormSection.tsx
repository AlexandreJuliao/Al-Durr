                    ...
                    <div className="space-y-12">
                        ...
                        {!hideInfo && (
                            <div className="space-y-10 border-t border-white/10 pt-10">
                                <div className="group">
                                    <h4 className="text-[10px] text-aldurr-honey uppercase tracking-[0.2em] font-bold mb-3">Showroom</h4>
                                    <p className="text-2xl font-light text-aldurr-text-body group-hover:text-aldurr-honey transition-colors">Lisboa, Portugal</p>
                                    <p className="text-aldurr-text-muted font-light text-sm mt-2">Av. da Liberdade (Por marcação)</p>
                                </div>
                                <div className="group">
                                    <h4 className="text-[10px] text-aldurr-honey uppercase tracking-[0.2em] font-bold mb-3">Contacto Direto</h4>
                                    <p className="text-2xl font-light text-aldurr-text-body group-hover:text-aldurr-honey transition-colors">+351 912 345 678</p>
                                    <p className="text-aldurr-text-muted font-light text-sm mt-2">geral@aldurr.pt</p>
                                </div>
                            </div>
                        )}
                    </div>
