                        ...
                        {!hideInfo && (
                            <div className="space-y-10 border-t border-white/10 pt-10">
                                ...
                                <div className="group">
                                    ...
                                    <a href="mailto:al.durr@outlook.com" className="text-aldurr-text-muted font-light text-sm mt-2 block hover:text-aldurr-honey transition-colors">al.durr@outlook.com</a>
                                </div>
                            </div>
                        )}
                    </div>
