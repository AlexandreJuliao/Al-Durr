                        ...
                        <div className="relative w-full max-w-[24rem] md:max-w-[28rem] lg:max-w-md text-left bg-transparent md:bg-aldurr-canvas/20 md:backdrop-blur-3xl px-2 md:p-8 md:rounded-sm border-transparent md:border md:border-white/10 md:shadow-[0_20px_80px_rgba(0,0,0,0.5)] overflow-hidden group">
                            ...
                            <div className="flex flex-col gap-5 lg:gap-12 relative z-10 w-full px-2">
                                ...
                                <div className="relative mt-4 group w-full">
                                    ...
                                    <button className="relative flex items-center justify-between gap-4 md:gap-6 pl-6 md:pl-8 pr-2 py-2 bg-white/5 backdrop-blur-md border border-white/10 rounded-sm hover:bg-white/10 transition-all duration-300 group w-full">
                                        ...
                                        <span className="flex-shrink-0 w-12 h-12 md:w-12 bg-gold-metallic text-aldurr-void rounded-none flex items-center justify-center transform group-hover:scale-[1.02] group-hover:rotate-45 transition-all duration-500 shadow-xl">
